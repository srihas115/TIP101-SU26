...
grade(search_insert_recursive)   # ▶ Run this file to validate your solution
...
==============================================================================
'''
# test([1, 3, 5, 6], 5, expected=2)   # checks the value your code returns against this example
