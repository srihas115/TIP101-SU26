[https://courses.codepath.org/courses/tip101/unit/8#feedback-modal](https://courses.codepath.org/courses/tip101/unit/8#feedback-modal)
## Unit 8 Cheatsheet
...
![Binary tree with parent node and left and right child](Unit Assets/binary_tree_example.png)
...
![Binary tree with height, child, parent, and root nodes labeled](Unit Assets/binary_tree_terminology.png)
...
![Balanced Binary Tree](Unit Assets/balanced_tree.png)


Below is an example of an unbalanced tree.


![Unbalanced Binary Tree](Unit Assets/unbalanced_tree.png)
...
![Binary Tree Preorder Animation](Unit Assets/preorder.gif)
Source: [via Tyler Willis](https://tylerewillis.com/page/depth-first-traversal-orders)
...
![Binary Tree Inorder Animation](Unit Assets/postorder.gif)
Source: [via Tyler Willis](https://tylerewillis.com/page/depth-first-traversal-orders)
...
![Binary Tree Inorder Animation](Unit Assets/inorder.gif)
Source: [via Tyler Willis](https://tylerewillis.com/page/depth-first-traversal-orders)
...
![Binary Search Tree](Unit Assets/bst.png)
...
![Binary Search Tree example with both key and value properties](Unit Assets/key_val_bst.png)
...
- [Unit 8 Breakout Problem Solutions](https://github.com/codepath/compsci_guides/wiki/TIP101-Unit-8)


#### Cheatsheet


- [Unit 8 Cheatsheet](https://courses.codepath.org/courses/tip101/unit/8#!cheatsheet)


#### Additional Resources


- [VisuAlgo BST Visualizer](https://visualgo.net/en/bst)
